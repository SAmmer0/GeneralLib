...
factor_list.append(Factor('NI_TTM', get_TTM('NPFromParentCompanyOwners', 'IS'),
                          pd.to_datetime('2017-07-25'), dependency=['LIST_STATUS'],
                          desc='净利润TTM'))
# 营业收入TTM
...
factor_list.append(Factor('OPPROFIT_TTM', get_TTM('OperatingProfit', 'IS'),
                          pd.to_datetime('2017-07-25'), dependency=['LIST_STATUS'], desc='营业利润TTM'))
# 销售费用TTM
...
factor_list.append(Factor('ADMINEXP_TTM', get_TTM('AdministrationExpense', 'IS'),
                          pd.to_datetime('2017-07-25'), dependency=['LIST_STATUS'], desc='管理费用TTM'))
# 财务费用TTM
...
factor_list.append(Factor('OPCOST_TTM', get_TTM('OperatingCost', 'IS'),
                          pd.to_datetime('2017-07-28'), dependency=['LIST_STATUS'],
                          desc='营业成本'))
# 经营活动中的现金流净额
factor_list.append(Factor('OPNETCF_TTM', get_TTM('NetOperateCashFlow', 'CFS'),
                          pd.to_datetime('2017-07-25'), dependency=['LIST_STATUS'], desc='经营活动中的现金流净额'))
# --------------------------------------------------------------------------------------------------
# 资产负债表最新数据
